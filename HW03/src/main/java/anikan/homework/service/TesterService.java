...
public class TesterService {
    ...
    public TesterService(QuestionService questionService, ScoreConfig scoreProperties, IOService ioService, UserService userService, LocaleMessagesSource localeMessagesSource, LocalizedIOService localizedIOService) {
